  ...
  return (
    <div className="about-us-container">
      ...
      <div className="content">
        ...
        <p>
          In summary, the MasomoLMS program is founded on the principles of providing accessible, comprehensive, and industry-relevant IT education. Through a combination of quality content, hands-on experience, and supportive community, we aim to empower learners to achieve their goals and pursue successful careers in Information Technology.
        </p>
      </div>
    </div>
  );
